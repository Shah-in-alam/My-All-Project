...
def course_recipe(i):
    """
        ...
        Parameters
            ...
            i = string
        Return
            The recipe of given vegetables
        """

    url = "https://chatgpt-api7.p.rapidapi.com/ask"

    payload = {"query": f"Generate a polish recipe made with {i}"}
    headers = {
...
given_title = f"Polish Dishes made with vegetables available in {current_month}" # A title for the pdf
image_path = "food.jpg" # The image of the food
given_text = content # The whole recipe of the food
output_file = "seasonal recipe.pdf" # The output pdf file name
